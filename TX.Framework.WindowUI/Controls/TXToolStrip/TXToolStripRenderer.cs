...
namespace TX.Framework.WindowUI.Controls
{
    ...
    public class TXToolStripRenderer : ToolStripRenderer
    {
            ...
            : base()
        {
            ...
            this.MenuImageBackImage = Properties.Resources.logo2013;
        ...
        protected override void OnRenderImageMargin(ToolStripRenderEventArgs e)
        {
            ...
            if (toolStrip is ToolStripDropDown)
            {
                ...
                if (img != null && this.ShowMenuBackImage)
                {
                    ...
                    g.DrawImage(Properties.Resources.logo2013, new Rectangle(rect.X + 1, rect.Y + 2, img.Width, img.Height), 0, 0, img.Width, img.Height, GraphicsUnit.Pixel, imgAttributes);
                }
